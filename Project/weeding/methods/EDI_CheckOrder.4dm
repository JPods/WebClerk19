...
QUERY:C277([Order:3]; [Order:3]idNum:2=[GenericParent:89]lI04:8)

ConsoleLog("Records In Selection([Order] = "+String:C10(Records in selection:C76([Order:3])))
	...
	: (Records in selection:C76([Order:3])=1)
		...
		Else 
			...
			If ([Order:3]status:59="@EXCEPTION@")
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status Exception"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			
			If ([Order:3]status:59="@REJECTED@")
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status REJECTED"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			
			If ([Order:3]status:59="@DUPLICATE@")
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status DUPLICATE"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			
			If ([Order:3]terms:23="@VOID@")
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status VOID"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			
			If ([Order:3]status:59="@HOLD@")
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status HOLD"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			
			If ([Order:3]profile4:103="@ERR@")
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status ERR"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			
			If (([Order:3]profile4:103="@P30@") | ([Order:3]profile4:103="@P31@"))
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status PICKED SPARKS"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			
			If ([Order:3]complete:83=2)
				[GenericParent:89]a03:60:="ORDER: "+String:C10([Order:3]idNum:2; "0000-0000")+" Status Completed"
				[GenericParent:89]bool03:17:=True:C214  // ERROR / FAIL
			End if 
			...
			If (([GenericParent:89]bool02:16=False:C215) & ([GenericParent:89]bool03:17=False:C215))  // Not Locked Order & Not // ERROR / FAIL 
				...
				ConsoleLog("srSO:=[Order]OrderNum")
