...
Else 
	...
	ConsoleLog("  ----  ")
	ConsoleLog("Items in table Start: "+"\t"+String:C10(Records in table:C83([Item:4])))
	ConsoleLog("Items in database: "+"\t"+String:C10($viRecordsInDB))
	...
	If ($cntCat>1)
			...
			Else 
				...
				Case of 
					: (Records in selection:C76([Item:4])>1)
						$vtTypeUpdate:=""
						ConsoleLog("Multiples: "+"\t"+$vtItemNum)
		...
		ConsoleLog([TallyResult:73]nameReal5:33+": "+"\t"+String:C10([TallyResult:73]real5:32))
		
		[TallyResult:73]nameReal6:37:="Malformed"
		[TallyResult:73]real6:42:=$viMalFormed
		ConsoleLog([TallyResult:73]nameReal6:37+": "+"\t"+String:C10([TallyResult:73]real6:42))
		
		[TallyResult:73]nameReal7:38:="In-Catalog"
		[TallyResult:73]real7:43:=Records in set:C195("In-Catalog")
		ConsoleLog([TallyResult:73]nameReal7:38+": "+"\t"+String:C10([TallyResult:73]real7:43))
		
		QUERY:C277([Item:4]; [Item:4]itemNum:1="@-"+$vtVendor)
		[TallyResult:73]nameReal8:39:="Records Final"
		[TallyResult:73]real8:44:=Records in selection:C76([Item:4])
		ConsoleLog([TallyResult:73]nameReal8:39+": "+"\t"+String:C10([TallyResult:73]real8:44))
		...
		ConsoleLog("Items in table Final: "+"\t"+String:C10(Records in table:C83([Item:4])))
		ConsoleLog("  ----  ")
