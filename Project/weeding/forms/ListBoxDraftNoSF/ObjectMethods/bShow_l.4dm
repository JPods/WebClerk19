...
obRec:=ds:C1482.FC.query(" tableName = :1 AND purpose = :2 "; tableName; "formDefault").first()
$vtScript:="Query([FieldCharacteristic];[FieldCharacteristic]id=\""+obRec.id+"\")"
// $vtScript:="obRec:=ds.FC.query(\" tableName = :1 AND purpose = :2 \"; "+tableName+"; \"formDefault\").first()"

ProcessTableOpen(Table:C252(->[FC:94]); $vtScript; "Template")
