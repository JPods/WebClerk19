Class constructor($callback : 4D:C1709.Function; $callbackID : Text; $enableStop : Boolean)
	...
	If (Count parameters:C259>0)
		...
		ASSERT:C1129(Value type:C1509($callback)=Is object:K8:27; "Callback must be type function.")
...
Function onData($systemworker : Object; $data : Object)
	...
	If (String:C10($data.data)#"")
		...
		If (This:C1470.callback#Null:C1517)
			...
			If ($pos>0)
				CALL WORKER:C1389("UI_ProgressCallback"; \
					This:C1470.callback.source; This:C1470.callbackID; \
					Substring:C12(This:C1470.data; 1; $pos-1); -1; \
					This:C1470.SharedForProgressBar)
				This:C1470.data:=Substring:C12(This:C1470.data; 1; $pos+1)
			End if 
		End if 
	End if 
	
Function onTerminate($systemworker : Object; $data : Object)
	CALL WORKER:C1389("UI_ProgressCallback"; This:C1470.callback.source; ""; 100; This:C1470.SharedForProgressBar)