...
Case of 
	: (Form event code:C388=On Load:K2:1)  // This event is generated at the start of loading a 
		...
		If (process_o.url=Null:C1517)
			process_o:=cs:C1710.cWebArea.new("WebClerk")
			process_o.set_url(New object:C1471("url"; "http://act.webclerk.com"))
			//vURL:=process_o.url
		End if 
		
		If (False:C215)
			vURL:="http://act.webclerk.com"
	...
	: (Form event code:C388=On End URL Loading:K2:47)  //: This event is generated when all the 
		...
		If (process_o.tinyMCE#Null:C1517)
