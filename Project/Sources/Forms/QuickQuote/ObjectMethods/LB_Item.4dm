...
Case of 
	: ($eventCode_i=On Load:K2:1)
		...
		var $obRec : Object
		$obRec:=ds:C1482.FieldCharacteristic.query("purpose = QuickQuoteColumns").first()
		If ($obRec=Null:C1517)
			// HOWTO: make default columns in list box
			
			vtFieldList:="itemNum,description,priceA,qtyOnHand,qtyOnPo,costMSC,class,id"
			$obSetup:=New object:C1471("listboxName"; "LB_Item"; "tableName"; "Item"; "fieldList"; vtFieldList; "priority"; "textBlock")
