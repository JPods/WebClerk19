...
// Modified by: Bill James (2022-04-29T05:00:00Z)
// Method: OutputDS.PopupDateBeg
// Description 
// Parameters
// ----------------------------------------------------

Case of 
	: (FORM Event:C1606.objectName#"PopupDateBeg")
		
	: (Form event code:C388=On Data Change:K2:15)
		var $o : Object
		$o:=OBJECT Get subform container value:C1785
		//process_o.dt.begin.date
		If ((dateBegin_d#Form:C1466.dt.begin.date) & (dateEnd_d#Form:C1466.dt.end.date))
			//process_o.queryActionChoices(dateBegin_d; dateEnd_d)
		End if 
	: (Form event code:C388=On Load:K2:1)
		dateBegin_d:=Form:C1466.dt.begin.date  // set in cProcess from storate.dateSpan.
		...
		// DatePicker RESET DEFAULT VALUES in storage.dateSpan.
		...
		// Tip : use 4D constants for code visibility
