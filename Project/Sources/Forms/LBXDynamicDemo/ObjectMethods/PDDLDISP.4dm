...
Case of 
	: (Form event code:C388=On Load:K2:1)
		//PDDLDISP:=find in array(PDDLDISP;
		PDDLDISP:=5
		STR_FieldsListBox
	: (Form event code:C388=On Data Change:K2:15)
		...
		Case of 
			...
			: (PDDLDISP=2)
				...
				If (Folder separator:K24:12=":")
					$demoSpanText:="<span style=\"font-family:'Lucida Grande'\"><span style=\"font-size:16pt\"><span style=\"font-weight:bold\"> Selection Based 2</span><br/></span><br/><span style=\"font-weight:bold\"> Description: </span><br/> Querying a table that display four fields.<br/><b"+"r/><span style=\"font-weight:bold\"> Table:</span> <br/> Customer<br/><br/><span style=\"font-weight:bold\"> Fields: </span><br/> id, nameFirst, nameLast, &amp; DOB<br/><br/><span style=\"font-weight:bold\"> Usage:</span><br/> Input:<br/> $1(LONGINT) - List"+"bo"+"x type<br/> $2(POINTER) - Datasource<br/> $3(POINTER) - Number of columns<br/><br/><br/><br/><br/><br/><br/><span style=\"font-weight:bold\"> Sample:<br/>  <span style=\"font-family:'Courier New';font-size:14pt;font-weight:normal\"><span style=\"color:#068"+"C00;font-weight:bold\">C_LONGINT</span>(<span style=\"color:#0031FF\">$nCol</span>)<br/> <span style=\"color:#0031FF\">$nCol</span>:=4 // 4 Columns</span><br/></span><span style=\"font-family:'Courier New';font-size:11pt\"><span style=\"color:#000088;font-sty"+"le:italic;font-weight:bold\"> <span style=\"font-size:14pt\">LBX_DemoDynamic_02</span></span><span style=\"font-size:14pt\"> (1;-&gt;<span style=\"color:#532300\">[Customer]</span>;-&gt;<span style=\"color:#0031FF\">$nCol</span>)</span></span></span>"
				Else 
					$demoSpanText:="<span><span style=\"font-size:12pt;font-weight:bold\"><span style=\"font-size:9pt;font-weight:normal\"><span style=\"font-size:12pt;font-weight:bold\"> Selection Based 2</span><br/><br/><span style=\"font-weight:bold\"> Description: </span><br/>  Querying a t"+"able that display four fields.<br/><br/><span style=\"font-weight:bold\"> Table:</span> <br/>  Customer<br/><br/><span style=\"font-weight:bold\"> Fields: </span><br/>  id, nameFirst, nameLast, &amp; age<br/><br/><span style=\"font-weight:bold\"> Usage:</sp"+"an"+"><br/>  Input:<br/>  $1(LONGINT) - Listbox type<br/>  $2(POINTER) - Datasource<br/>  $3(POINTER) - Number of columns<br/></span><br/></span><br/><br/><br/><br/><br/><br/><span style=\"font-weight:bold\"> Sample:<br/><span style=\"font-family:'Courier New"+"';font-weight:normal\"><span style=\"color:#00B050;font-weight:bold\"> <span style=\"font-size:10.5pt;color:#000000;font-weight:normal\"><span style=\"color:#068C00;font-weight:bold\">C_LONGINT</span>(<span style=\"color:#0031FF\">$nCol</span>)</span></span><s"+"pan style=\"font-size:10.5pt\"><br/> <span style=\"color:#0031FF\">$nCol</span>:=4 // 4 Columns<br/></span></span></span><span style=\"font-family:'Courier New';font-size:10.5pt\"><span style=\"color:#000088;font-style:italic;font-weight:bold\"> generateListb"+"oxFormJSONDef</span> (1;-&gt;<span style=\"color:#532300\">[Customer]</span>;-&gt;<span style=\"color:#0031FF\">$nCol</span>)</span></span>"
				End if 
				demoText:=Replace string:C233($demoSpanText; "\\\""; "\"")
			...
			: (PDDLDISP=5)
				...
				$form:=LBX_DemoDynamic_02(4; ->eSel; ->colNames1)  // Entity Collection #1
				jsonText:=JSON Stringify:C1217($form; *)
			...
			: (PDDLDISP{PDDLDISP}="MyTest22")
				
				
				var $obSetup; $field_o; $listboxSetup_o : Object
				var $fieldList_t; $tableName : Text
				$tableName:="Customer"
				$fieldList_t:="company,nameFirst,actionDate,id"
				
				// MustFixQQQZZZ: Bill James (2021-09-02T05:00:00Z)
				var $form : Object
				
				
				$obSetup:=New object:C1471("listboxName"; "LB_"+$tableName; "tableName"; $tableName; "fieldList"; $fieldList_t)
