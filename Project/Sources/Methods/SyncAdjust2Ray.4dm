...
Case of 
	...
	: ($ptCurFile=(->[Service:6]))
		...
		SyncChckEchoRay(->[Order:3]; ->[Service:6]; ->[Service:6]orderNum:22; ->[Service:6]comment:11)
		SyncChckEchoRay(->[Invoice:26]; ->[Service:6]; ->[Service:6]invoiceNum:23; ->[Service:6]comment:11)
		SyncChckEchoRay(->[Proposal:42]; ->[Service:6]; ->[Proposal:42]proposalNum:5; ->[Service:6]comment:11)
	...
	: ($ptCurFile=(->[Invoice:26]))
		...
		SyncChckEchoRay(->[Order:3]; ->[Invoice:26]; ->[Invoice:26]orderNum:1; ->[Invoice:26]comment:43)
