...
entry_o:=$entRec.toObject()

Case of 
	: (($tableName="Order") | ($tableName="OrderLine"))
		var OrderLineDisplayed; entry_o : Object
		entry_o:=ds:C1482.Order.query("id = :1"; $fromMain_o.id).first()
		...
		LB_OrderLine.ents:=ds:C1482.OrderLine.query("idNumOrder = :1"; entry_o.idNum)
		
		OBJECT SET SUBFORM:C1138(*; "SF_Lines"; "OrderLine")  //; LB_OrderLine.data)
		//primary_o:=
		//Form.entry_o.Order:=primary_o
