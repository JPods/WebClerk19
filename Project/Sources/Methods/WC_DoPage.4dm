...
//$0:=<>WebFolder+"Error.html"
$0:=<>WebFolder+"Error.html"  // # AZM #### // 20171212_0905 - NEED TO SHOW ERROR FROM CORRECT FOLDER
...
If ($cntParameters>0)
	...
	If ($Page2#"")
		If (Position:C15("."; $Page2)=0)  //page without the extension
			$Page2:=$Page2+".html"
		End if 
		//$0:=<>WebFolder+$Page2  //  <>WebFolder+$pathDepth+$Page2 $pageDepth to subfolders should be listed on the page
		$0:=<>WebFolder+$Page2  // # AZM #### // 20190409 - NEED TO SHOW ERROR FROM CORRECT FOLDER
	Else 
		If ($Page1="")
		...
		$0:=<>WebFolder+$Page1  // # AZM #### // 20171212_0905 - NEED TO SHOW ERROR FROM CORRECT FOLDER
	End if 
Else 
