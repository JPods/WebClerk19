//%attributes = {}
// -----------------------------------------------------------------
// From: dynamicListBoxDemo
// ----------------------------------------------------
// User name (OS): Bill James
// Date and time: 10/07/21, 22:41:59
// Method: LBX_FormJSONDef
...
If (False:C215)
	...
	colLB1:=New collection:C1472(New object:C1471("fname"; "Bob"; \
		"lname"; "James"; "age"; 39); New object:C1471("fname"; "Vinn"; \
		"lname"; "Michaels"; "age"; 38))
	
	// LBX_DemoDynamic_02 (3;->colLB1;->colNames0)
	LBX_FormJSONDef(3; ->colLB1; ->colNames0)
End if 
// ------------------------------------------------------------------
