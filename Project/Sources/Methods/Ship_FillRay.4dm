...
$k:=Records in selection:C76([Vendor:38])+Records in selection:C76([Customer:2])+Records in selection:C76([Contact:13])
...
If ($k>0)
	...
	If ($cntRecs>0)
		...
		SELECTION TO ARRAY:C260([Customer:2]; aTmpLong1; [Customer:2]company:2; aQueryFieldNames; [Customer:2]city:6; aTmp40Str2; [Customer:2]zip:8; aTmp12Str1; [Customer:2]phone:13; aTmp20Str1; [Customer:2]customerID:1; aTmp10Str1; [Customer:2]repID:58; aTmp25Str1; [Customer:2]nameLast:23; aTmp35Str1; [Customer:2]nameFirst:73; aTmp20Str3)
	...
	If ($cntRecs>0)
		SELECTION TO ARRAY:C260([Contact:13]; aTmpLong1; [Contact:13]company:23; aQueryFieldNames; [Contact:13]city:8; aTmp40Str2; [Contact:13]zip:11; aTmp12Str1; [Contact:13]phone:30; aTmp20Str1; [Contact:13]salesNameID:39; aTmp25Str1; [Contact:13]nameLast:4; aTmp35Str1; [Contact:13]nameFirst:2; aTmp20Str3)
		ARRAY TEXT:C222(aTmp2Str1; $cntRecs)
	...
	For ($i; 1; $cntRecs)
		Case of 
			...
			: (Length:C16(aCustPhone{$i})=10)
				aCustPhone{$i}:=Substring:C12(aCustPhone{$i}; 1; 3)+" "+Substring:C12(aCustPhone{$i}; 4; 3)+"-"+Substring:C12(aCustPhone{$i}; 7; 30)
			Else 
				aCustPhone{$i}:=Substring:C12(aCustPhone{$i}; 1; 4)+"."+Substring:C12(aCustPhone{$i}; 5; 4)+"."+Substring:C12(aCustPhone{$i}; 9; 30)
		End case 
	End for 
Else 
	Case of 
