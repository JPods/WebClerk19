...
C_OBJECT:C1216($displayedSelection; $dataStore; $dataClass; $criteria; $dsDescription)
C_TEXT:C284($dataClassName)
//Util25_OrderSelection_ (Simple or Extended)
...
$formData.dataStore:=$dataStore
$formData.dataClass:=$dataClass  //This is the  Table to sort
$formData.dataClassName:=$dataClass.getInfo().name
...
$formData.propertyListOriginal:=QRY_GetPropertyList("SORT"; $formData; $displayedSelection)
...
$w:=Open form window:C675("QRY_OrderBy"; Movable form dialog box:K39:8; Horizontally centered:K39:1; Vertically centered:K39:4; *)
SET WINDOW TITLE:C213("Order "+$dataClass.getInfo().name+" by..."; $w)

DIALOG:C40("QRY_OrderBy"; $formData)
