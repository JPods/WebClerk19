...
If ($6="")
	$1->:=0
	If (allowAlerts_boo)
		_O_OBJECT SET COLOR:C271($1->; -(Black:K11:16+(256*White:K11:1)))
	End if 
Else 
	...
	If (($1-><0) & ($2->=0))
		...
		If (allowAlerts_boo)
			// PLAY("CreditCheck")
			BEEP:C151
			_O_OBJECT SET COLOR:C271($1->; -(Black:K11:16+(256*Yellow:K11:2)))  //SET COLOR (bInfo;  (vForeground + (256 * vBackground)))
			//    INVERT BACKGROUND($1)
		End if 
	Else 
		If (allowAlerts_boo)
