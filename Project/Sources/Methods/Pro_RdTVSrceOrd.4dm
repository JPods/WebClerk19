...
//Procedure: Pro_RdTVSrceOrd
//read the TextValue field for the [Profile] 
//from the current Orders with a specific name
...
QUERY:C277([Profile:59]; [Profile:59]tableNum:1=Table:C252(->[Order:3]); *)
QUERY:C277([Profile:59];  & [Profile:59]DocNumID:2=[Order:3]orderNum:2; *)
