...
//
If (False:C215)
	//Method: Method: ItemExpanderMenu
	Version_0501
	//Date: 01/05/05
	//Who: Bill
	//Description: 
	...
	If ($keepGoing)
		...
		If ($rightSize)
			Repeat 
				...
				Else 
					$cntRecs:=$cntRecs+1
					MESSAGE:C88(String:C10($cntRecs))
					...
					Case of 
						: ($cntOptions=1)
							$menuText:=$menuText+"<select name="+Txt_Quoted("jitExtend1")+">"+"\r"
							$menuText:=$menuText+"<option value="+Txt_Quoted("")+">"+$aCatagory{1}+"</Option>"+"\r"
							For ($incItem; 1; $cntRay)
								//<select name="jitExtend1">
								//<option value="12" selected="selected">12
								//<option value="14">14
								//<option value="16">16
								//<option value="30">30
								//</select>
								$menuText:=$menuText+"<option value="+Txt_Quoted($aSKUComponent{$incItem})+">"+$aLable{$incItem}+"</Option>"+"\r"
							End for 
							[Item:4]menu:108:=$menuText+"</select>"+"\r"
							SAVE RECORD:C53([Item:4])
						...
						: ($cntOptions=2)
							...
							$menuText:=$menuText+"<select name="+Txt_Quoted("jitExtend1")+">"+"\r"
							$menuText:=$menuText+"<option value="+Txt_Quoted("")+">"+$aCatagory1{1}+"</Option>"+"\r"
							For ($incItem1; 1; $cntRay1)
								$menuText:=$menuText+"<option value="+Txt_Quoted($aSKUComponent1{$incItem1})+">"+$aLable1{$incItem1}+"</Option>"+"\r"
							End for 
							$menuText:=$menuText+"</select>"+"\r"
							
							$menuText:=$menuText+"<select name="+Txt_Quoted("jitExtend2")+">"+"\r"
							$menuText:=$menuText+"<option value="+Txt_Quoted("")+">"+$aCatagory2{1}+"</Option>"+"\r"
							For ($incItem2; 1; $cntRay2)
								$menuText:=$menuText+"<option value="+Txt_Quoted($aSKUComponent2{$incItem2})+">"+$aLable2{$incItem2}+"</Option>"+"\r"
							End for 
							[Item:4]menu:108:=$menuText+"</select>"+"\r"
							SAVE RECORD:C53([Item:4])
						...
						: ($cntOptions=3)
							...
							$menuText:=$menuText+"<select name="+Txt_Quoted("jitExtend3")+">"+"\r"
							$menuText:=$menuText+"<option value="+Txt_Quoted("")+">"+$aCatagory3{1}+"</Option>"+"\r"
							For ($incItem3; 1; $cntRay3)
								$menuText:=$menuText+"<option value="+Txt_Quoted($aSKUComponent3{$incItem3})+">"+$aLable3{$incItem3}+"</Option>"+"\r"
							End for 
							[Item:4]menu:108:=$menuText+"</select>"+"\r"
							SAVE RECORD:C53([Item:4])
