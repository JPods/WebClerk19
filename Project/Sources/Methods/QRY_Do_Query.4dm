...
C_OBJECT:C1216($dataStore; $dataClass; $criteria; $displayedSelection; $lineInfos; $dsDescription)
...
$formData.dataClass:=$dataClass  //This is the  Table search on
...
SET WINDOW TITLE:C213("Query "+$dataClass.getInfo().name+" with..."; $w)
