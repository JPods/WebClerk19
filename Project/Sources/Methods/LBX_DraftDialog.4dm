...
Else 
	...
	$new_o:=New object:C1471("LB_Fields"; New object:C1471; \
		"LB_Tables"; New object:C1471; \
		"LB_Selection"; New object:C1471("ents"; New object:C1471; "cur"; New object:C1471; "sel"; New object:C1471; "pos"; -1); \
		"process_o"; process_o)
	$obWindows:=WindowCountToShow
	
	// clean this up to just process_o
