...
$viInvoiceNum:=[InvoiceLine:54]invoiceNum:1
$0:=[InvoiceLine:54]invoiceNum:1
If ([Invoice:26]invoiceNum:2#[InvoiceLine:54]invoiceNum:1)
...
Else 
	...
	If ([InvoiceLine:54]typeSale:27#(Old:C35([InvoiceLine:54]typeSale:27)))
		...
		OrdSetPrice(->[InvoiceLine:54]unitPrice:9; ->[InvoiceLine:54]discount:10; [InvoiceLine:54]qtyShipped:7; ->pComm)
	...
	Else 
		...
		$dOnOrd:=0
		$dOnHand:=[InvoiceLine:54]qtyShipped:7-Old:C35([InvoiceLine:54]qtyShipped:7)
