				...
				Else 
					...
					For ($r; $cntRay; 1; -1)
						If (LSDistAmts{$r}#0)
							...
							End if 
							SEND PACKET:C103(sumDoc; "\t"+"\t"+"\t"+"\t"+$payID+"\t"+$v1+"\t"+$v2+"\t"+$v3+"\t"+String:C10([InventoryStack:29]idReceipt:16)+"\t"+String:C10([InventoryStack:29]docid:5)+"\t"+[InventoryStack:29]vendorID:10+"\t"+[InventoryStack:29]itemNum:2+"\r")
