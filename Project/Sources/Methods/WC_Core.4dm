...
Case of 
	...
	Else 
		...
		//SET BLOB SIZE(vblWCResponse; 0)
		//$myMessage:="Heart_beat reply from: "+Storage.default.company+", Version: "+Storage.version.rev
		//TEXT TO BLOB($myMessage; vblWCResponse; UTF8 text without length; *)
		//Http_SendWWWHd($socket; "text/html"; BLOB size(vblWCResponse))
