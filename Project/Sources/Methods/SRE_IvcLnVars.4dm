...
SRVarNames{$w+30}:="4;pvProfile1;pvProfile1;1"
SRVarNames{$w+31}:="4;pvProfile2;pvProfile2;1"
SRVarNames{$w+32}:="4;pvProfile3;pvProfile3;1"
SRVarNames{$w+33}:="4;pvShipOrdSt;pvShipOrdSt;1"
SRVarNames{$w+34}:="4;curLines;curLines;1"
SRVarNames{$w+35}:="2;pvTimesPrnt;pvTimesPrnt;1"
SRVarNames{$w+36}:="4;pvNameID;pvNameID;1"
SRVarNames{$w+37}:="4;pvLnComment;pvLnComment;1"
SRVarNames{$w+38}:="4;<>exUnPrice;<>exUnPrice;1"
SRVarNames{$w+39}:="4;<>exUnExPrice;<>exUnExPrice;1"
SRVarNames{$w+40}:="4;<>exUnCost;<>exUnCost;1"
SRVarNames{$w+41}:="4;<>exUnExCost;<>exUnExCost;1"