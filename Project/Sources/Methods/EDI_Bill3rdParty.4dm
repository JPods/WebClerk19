...
// Date and time: 09/14/16, 15:47:13
// ----------------------------------------------------
// Method: EDI_Bill3rdParty
// Description
// 
//
// Parameters
// ----------------------------------------------------
// ### jwm ### 20160914_1530 added method to debug Siemens EDI
...
// Storage.char.crlf;vHere
// C_REAL(AddressShipFrom;Profile5;Profile5)
C_BOOLEAN:C305(allowAlerts_boo)
C_LONGINT:C283(viContinue; viCount; viRecords)
C_TEXT:C284(vt3rdAddress1; vt3rdAddress2; vt3rdAttention; vt3rdCity; vt3rdCompany; vt3rdCountry)
C_TEXT:C284(vt3rdFax; vt3rdPhone; vt3rdState; vt3rdType; vt3rdZip; vtAccount; vtBillTo; vText; vText1)
C_TEXT:C284(vtResult; vtServiceType)
...
If ([Order:3]upsBillingOption:89="Bill 3rd Party@")
	...
	If (viContinue=1)  // Search Contacts
		...
		QUERY:C277([Contact:13]; [Contact:13]keyTags:14="@B3P@"; *)
...
[Order:3]profile5:104:=Preg Replace("B3[0-9] "; ""; [Order:3]profile5:104; Regex Ignore Case+Regex Multi Line)
