...
If (OK=1)
	...
	QUERY:C277([Proposal:42];  & ; [Proposal:42]proposalNum:5<1000)
	...
	vi11:=[Proposal:42]proposalNum:5
	CONFIRM:C162("Reset CloneAllowed starting from: "+String:C10(vi11))
	If (OK=1)
		QUERY:C277([Proposal:42]; [Proposal:42]salesNameID:9="CloneAllowed"; *)
		QUERY:C277([Proposal:42];  & ; [Proposal:42]proposalNum:5>999)
		...
		If (OK=1)
			For (vi1; 1; vi2)
				...
				CONFIRM:C162("Reset: "+String:C10([Proposal:42]proposalNum:5)+", Lines: "+String:C10(vi4))
				If (OK=1)
					If (vi4=0)
