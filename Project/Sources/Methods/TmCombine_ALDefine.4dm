...
C_TEXT:C284($2)
// -- $error:=AL_SetArraysNam($1; 1; 6; "aTextTime"; "aTextSchedule1"; "aTextSchedule2"; "aTextSchedule3"; "aTextSchedule4"; "aTextSchedule5")
//
// -- AL_SetHeaders($1; 1; 6; "Times"; vText1; vText2; vText3; vText4; vText5)
// -- AL_SetWidths($1; 1; 6; 50; 100; 100; 100; 100; 100)
// -- AL_SetRowOpts($1; 1; 1; 1; 0; 1)
//Name; Multi; AllowNoSelect; DragLine; AcceptDrag; MoveWithData
//$columnCnt:=Num(Error#0)*8
// -- AL_SetColOpts($1; 1; 0; 1; 0; <>viPixel)  //$columnCnt;0)
