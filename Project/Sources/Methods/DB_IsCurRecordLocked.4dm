...
C_BOOLEAN:C305($0; $vbCurRecordIsLocked)
$vbCurRecordIsLocked:=False:C215
...
If (WCR_IsResource($vtResourceName))
	...
	$vbCurRecordIsLocked:=Locked:C147($vpTable->)
