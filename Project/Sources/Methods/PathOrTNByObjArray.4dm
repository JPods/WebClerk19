...
// Date and time: 06/08/20, 23:25:56
// ----------------------------------------------------
// Method: PathOrTNByObjArray
// Description
// 
//
// Parameters
...
C_TEXT:C284($vtPath)
C_LONGINT:C283($i; $k)
ARRAY OBJECT:C1221($obRecordArray; 0)
$k:=Size of array:C274($obRecordArray)
For ($i; 1; $k)
	$vtPath:=PathOrTN($tableName; $vtThumbnail)
	$obRecordArray{$i}.ImagePath:=$vtPath
End for 
