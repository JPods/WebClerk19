...
// Date and time: 07/06/07, 08:09:11
// ----------------------------------------------------
// Method: ItemMfrCommission
// Description
// 
//
// Parameters
...
C_TEXT:C284($itemNum)
$itemNum:="Com"+[Customer:2]customerID:1+"1"
...
If (Records in selection:C76([Item:4])=0)
	...
	[Item:4]imagePath:104:="logo.jpg"
	[Item:4]imagePathTn:114:="logoTN.jpg"
	[Item:4]discountable:28:=True:C214
	[Item:4]specid:62:="*****"
	[Item:4]taxID:17:="NoTax"
	[Item:4]mfrName:91:=[Customer:2]company:2
	If (allowAlerts_boo)
		CONFIRM:C162("Do you wish to publish this item at this time?")
		If (OK=1)
			[Item:4]publish:60:=1
		End if 
	Else 
	...
	Execute_TallyMaster("ManufacturerItem"; "ManagementReport")
