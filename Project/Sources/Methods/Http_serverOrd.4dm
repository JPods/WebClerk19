...
//If (($tableNum>0) & (Num($recordStr)>0))
//vResponse:="ShipTo set as: "+$tableName+", Record Number:  "+$recordStr
//[EventLog]shipToRecordid:=Num($recordStr)
//[EventLog]shipToTableNum:=$tableNum
//If ([EventLog]idNum#0)
//SAVE RECORD([EventLog])
//End if 
...
//End case 
//If ($jitPageOne#"")
//Http_OrdFill($c; $2; False)  //calculate order but do not save   // ### jwm ### 20150930_1502  
