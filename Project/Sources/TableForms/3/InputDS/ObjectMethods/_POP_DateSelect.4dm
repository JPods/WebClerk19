...
// Method: [Customer].InputDS.PopupDate
// Description 
// Parameters
// ----------------------------------------------------
// https://developer.4d.com/docs/en/FormObjects/dropdownListOverview.html#docsNav

Case of 
	: (Form event code:C388=On Data Change:K2:15)
		If (process_o.entry_o.actionDate#Null:C1517)
			entry_o.actionDate:=vActionDate
		End if 
	: (Form event code:C388=On Load:K2:1)
		...
		If (process_o.entry_o.actionDate#Null:C1517)
			vActionDate:=process_o.entry_o.actionDate
		Else 
