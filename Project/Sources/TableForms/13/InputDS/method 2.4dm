...
Else 
	...
	If ($doMore)
		...
		jFormatPhone(->[Customer:2]phone:13)
		jFormatPhone(->[Contact:13]phone:30)
		jFormatPhone(->[Contact:13]fax:31)
		jFormatPhone(->[Contact:13]phoneCell:52)
		booAccept:=True:C214
		REDUCE SELECTION:C351([CallReport:34]; 0)
		REDUCE SELECTION:C351([QA:70]; 0)
		jNxPvButtonSet(->aServiceRecs)
		
		QA_LoOnEntry(eAnsListContacts; 13; String:C10([Contact:13]idNum:28); 0; 0)
