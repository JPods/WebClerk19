	...
	Case of 
		...
		: ($formEvent=On Load:K2:1)
			...
			Else 
				...
				ALL RECORDS:C47([DefaultSetup:86])
				//  CHOPPED  AL_UpdateFields(eDefaultSettings; 2)
				...
				If (Storage:C1525.wc.localHost#"")
					iLoaText2{2}:=Storage:C1525.wc.localHost
				Else 
				...
				//  Put  the formating in the form  jFormatPhone(->[Default]fax; ->[Default]phone)
				//
				...
				//
				vi2:=0
				If ([Default:15]emailServer:95="")
					
					[Default:15]emailServer:95:=<>tcEmailSrvr
				End if 
