...
If ($doMore)  //action for the form regardless of new or existing record
	...
	Doc_FillArrays(Records in selection:C76([Document:100]))
	If (eListDocuments>0)
		AL_UpdateArrays(eListDocuments; -2)
	End if 
	QUERY:C277([Discussion:139]; [Discussion:139]ideForeign:4=[TechNote:58]idNum:1; *)
	QUERY:C277([Discussion:139];  & [Discussion:139]tableNum:2=Table:C252(->[TechNote:58]))
