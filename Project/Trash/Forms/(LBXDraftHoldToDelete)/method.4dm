...
Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		Form:C1466.Draft:=New object:C1471("up"; Form:C1466)
		Form:C1466.LB_Draft_cur:=New object:C1471
		Form:C1466.LB_Draft_sel:=New collection:C1472
	...
	: ($event_o.code=On Clicked:K2:4)
		...
		Case of 
			...
			: ($event_o.objectName="LB_Draft")
				...
				Form:C1466.LB_Draft_cur:=LB_Draft_cur.toObject()
				Form:C1466.LB_Draft_sel:=New collection:C1472
				Form:C1466.LB_Draft_sel:=LB_Draft_sel.toCollection()
